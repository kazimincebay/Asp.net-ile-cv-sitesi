<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminEgitimGuncelle.aspx.cs" Inherits="cv.WebForm2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <br />
                <asp:Button ID="Button1" runat="server" Text="Eğitim Bilgisi Güncelle" CssClass="btn btn-success" OnClick="Button1_Click" />
